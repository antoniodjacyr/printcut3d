...
export const dictionary: Record<Locale, Record<string, string>> = {
  en: {
    ...
    dashNavUsers: "Users",
    dashNavPipeline: "Production pipeline",
  ...
  pt: {
    ...
    dashNavOrders: "Pedidos",
    dashNavUsers: "Usuários",
    dashNavPipeline: "Pipeline de produção",
  ...
  es: {
    ...
    dashNavCatalog: "Catálogo",
    dashNavOrders: "Pedidos",
    dashNavUsers: "Usuarios",
    dashNavPipeline: "Pipeline de producción",
    dashNavShipping: "Logística",
